...
export default () => (
  <div>
    <h1>Mac OS UI Games</h1>
    <p>
      Two rather simple games, but based on the Mac OS X Interface.
      This approach shows how the things you are used to, obtain new
      meaning. My games is continuation of finding the way of
      interaction between the OS and the user on levels that are
      slightly noticeable at first sight.
    </p>
    ...
    <p>
      ...
      folder in Cover Flow mode and in contrast WI the original game
      the movement of the slots is horizontal.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        folder will be randomly copied 600 times to the folders first,
        second mad third
        <br />$ php game.php
      </li>
    </ul>

    <p>Now you can play. Ideally with the trackpad.</p>
    ...
    <p>
      ...
      randomly and gives a combination of two dices.
    </p>
