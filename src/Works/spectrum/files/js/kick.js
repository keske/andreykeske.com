(function(undefined) {
  var Kick = function(dancer, o) {
    ...
    this.dancer = dancer;
    this.frequency =
      o.frequency !== undefined ? o.frequency : [0, 10];
  ...
  Kick.prototype = {
    ...
    set: function(o) {
      o = o || {};
      this.frequency =
        o.frequency !== undefined ? o.frequency : this.frequency;
      this.threshold =
        o.threshold !== undefined ? o.threshold : this.threshold;
    ...
    onUpdate: function() {
      ...
      if (
        magnitude >= this.currentThreshold &&
