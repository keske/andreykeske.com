...
!(function (t, r) {
  ...
  (function () {
    (tracking.EventEmitter = function () {}),
      ...
      (tracking.EventEmitter.prototype.removeAllListeners = function (
        t,
      ) {
        return this.events_
      ...
      (tracking.EventEmitter.prototype.removeListener = function (
        t,
        r,
      ) {
        if ('function' != typeof r)
  ...
  (function () {
    (tracking.Image = {}),
      ...
      (tracking.Image.computePixelValueSAT_ = function (
        t,
        r,
        n,
        e,
      ...
      (tracking.Image.equalizeHist = function (t, r, n) {
        for (
          var e = new Uint8ClampedArray(t.length),
            a = new Array(256),
            i = 0;
          i < 256;
          i++
  ...
  (function () {
    (tracking.Math = {}),
      ...
      (tracking.Math.intersectRect = function (
        t,
        r,
        n,
        e,
  ...
  (function () {
    (tracking.Matrix = {}),
      ...
      (tracking.Matrix.sub = function (t, r) {
        for (
          var n = tracking.Matrix.clone(t), e = 0;
          e < n.length;
          e++
        )
      ...
      (tracking.Matrix.mulScalar = function (t, r) {
        for (
          var n = tracking.Matrix.clone(r), e = 0;
          e < r.length;
          e++
        )
      ...
      (tracking.Matrix.transpose = function (t) {
        for (
          var r = new Array(t[0].length), n = 0;
          n < t[0].length;
          n++
        ) {
      ...
      (tracking.Matrix.calcCovarMatrix = function (t) {
        ...
        for (
          var a = tracking.Matrix.clone(r), n = 0;
          n < a.length;
          n++
        )
      ...
      (tracking.TrackerTask.prototype.stop = function () {
        if (this.inRunning())
          return (
            this.setRunning(!1),
            this.emit('stop'),
            this.tracker_.removeListener(
              'track',
              this.reemitTrackEvent_,
            ),
            this
          );
      });
  ...
  (function () {
    (tracking.ColorTracker = function (t) {
      ...
      (tracking.ColorTracker.prototype.getNeighboursForWidth_ = function (
        t,
      ) {
      ...
      (tracking.ColorTracker.prototype.mergeRectangles_ = function (
        t,
      ) {
        for (
          var r,
      ...
      (tracking.ColorTracker.prototype.setMinDimension = function (
        t,
      ) {
        this.minDimension = t;
      }),
      (tracking.ColorTracker.prototype.setMaxDimension = function (
        t,
      ) {
        this.maxDimension = t;
      }),
      (tracking.ColorTracker.prototype.setMinGroupSize = function (
        t,
      ) {
        this.minGroupSize = t;
      }),
      ...
      tracking.ColorTracker.registerColor('magenta', function (
        t,
        r,
        n,
      ) {
      ...
      tracking.ColorTracker.registerColor('yellow', function (
        t,
        r,
        n,
      ) {
  ...
  (function () {
    (tracking.ObjectTracker = function (t) {
      ...
      (tracking.ObjectTracker.prototype.setClassifiers = function (
        t,
      ) {
        this.classifiers = t;
      }),
      (tracking.ObjectTracker.prototype.setEdgesDensity = function (
        t,
      ) {
        this.edgesDensity = t;
      }),
      (tracking.ObjectTracker.prototype.setInitialScale = function (
        t,
      ) {
        this.initialScale = t;
      }),
      (tracking.ObjectTracker.prototype.setScaleFactor = function (
        t,
      ) {
        this.scaleFactor = t;
      }),
  ...
  (function () {
    (tracking.LandmarksTracker = function () {
      ...
      tracking.inherits(
        tracking.LandmarksTracker,
        tracking.ObjectTracker,
      ),
      (tracking.LandmarksTracker.prototype.track = function (
        t,
        r,
        n,
      ) {
  ...
  (function () {
    (tracking.LBF = {}),
      ...
      (tracking.LBF.Regressor.deriveBinaryFeat = function (
        ...
        for (
          var g = 1 << (t.maxDepth - 1), o = 0;
          o < r.length;
          o++
        ) {
          for (
            var h = tracking.LBF.unprojectShapeToBoundingBox_(
                n[o],
                e[o],
              ),
  ...
  (function () {
    (tracking.LBF.maxNumStages = 4),
      ...
      (tracking.LBF.projectShapeToBoundingBox_ = function (t, r) {
        for (var n = new Array(t.length), e = 0; e < t.length; e++)
          n[e] = [
            t[e][0] * r.width + r.startX,
            t[e][1] * r.height + r.startY,
          ];
        return n;
      }),
      (tracking.LBF.similarityTransform_ = function (t, r) {
        ...
        (n[0] /= t.length),
          ...
          (e[1] /= r.length);
        for (
          var i = tracking.Matrix.clone(t),
            o = tracking.Matrix.clone(r),
            a = 0;
          a < t.length;
          a++
        )
      ...
      (tracking.LBF.RandomForest = function (t) {
        (this.maxNumTrees =
          tracking.LBF.RegressorData[t].max_numtrees),
          (this.landmarkNum =
            tracking.LBF.RegressorData[t].num_landmark),
