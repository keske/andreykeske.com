...
export const Description: React.FC = () => (
  <div className="flex h-screen flex-col items-center justify-center gap-10 py-60">
    <div className="flex w-1/2 flex-col gap-5 px-10 text-2xl font-black uppercase md:w-2/3 lg:w-1/2 xl:w-1/2">
      ...
      <p>
        He began his artistic journey in 2006 by creating graffiti, which
        evolved into making stickers and graphic designs.
      </p>
      <p>
        ...
        convergence of these two activities.
      </p>
      <p>
        This convergence ultimately led him to create net-art, which is
