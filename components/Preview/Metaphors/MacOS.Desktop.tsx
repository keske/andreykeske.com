    ...
    <div className="flex w-screen flex-col items-center justify-center gap-5">
      ...
      <WorkDetails>
        <div className="flex w-1/2 flex-col gap-2">
          ...
          <small>
            This mysterious void appears on the computer screen as a black
            circle, and any information or object that falls into it is
            seemingly removed from existence forever.
          </small>
          <small>
    ...
    <div className="flex w-screen flex-col items-center justify-center gap-5">
      ...
      <WorkDetails>
        <div className="flex w-1/2 flex-col gap-2">
          ...
          <small>
            The exhibit is inspired by the theory of Hawking radiation, which
            suggests that quantum perturbations of the event horizon could allow
