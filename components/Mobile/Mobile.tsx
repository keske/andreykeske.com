...
const Mobile: React.FC = () => (
  <Stack className="h-screen justify-center p-10 md:hidden" gap={5}>
    <p>
      ...
      and graphic designs. Graffiti, a form of street art, can be seen
      as a type of hacking, and Andrey's interest in computer hacking
      culture and programming led to a convergence of these two
      activities. This convergence ultimately led him to create
